...
<script src="/js/reg_incom.js" type="text/javascript"></script>
	...
	@font-face {
        ...
        input[type="text"],input[type="tel"],input[type="email"],input[type="password"],input[type="number"],textarea,input[type="date"],input[type="time"]{
            outline: none;
            border: none;
            border-radius: 2px;
/*            background-image: url(/views/img/konvert.png);
...
/*            background-image: url(/views/img/konvert.png);
        ...
        input[type="password"]{
/*            background-image: url(/views/img/zamok.png);
            background-repeat: no-repeat;
            */
        }
        select{font-family: HelveticaMedium; }
        div{font-family: HelveticaMedium; }
        select{font-family: HelveticaMedium; }
        a{font-family: HelveticaMedium; }
        header{height: 10%; font-family: HelveticaMedium; }
